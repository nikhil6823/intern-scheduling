...
const AdminDashboard = () => {
  ...
  const options = [{ link: "admin-home", value: "Home" }, { link: "admin-view", value: "View" },{link:"show-department",value:"Show Departments"},{ link: "update-leave", value: "LeaveRequest" }, {link:"add-department",value:"Add Department"},{ link: "logout", value: "Logout" }];
    ...
    const fetchInternsAndDepartments = async () => {
      try {
        ...
        if (departmentsResponse.ok) {
          ...
          console.error('Failed to fetch departments:', departmentsResponse.statusText);
        }
      } catch (error) {
  ...
  return (
    ...
    <button className='schedule-duty' onClick={scheduleDuties}>Schedule Duties</button>
      {/* Interns table */}
